                    ...
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-anim layui-anim-up">
                            ...
                            <form action="login" class="layui-form layui-form-pane"
                                ...
                                <div class="layui-form-item">
                                    <input type="radio" name="identity" lay-skin="primary" value="reader" title="普通用户"
                                           checked>
                                    <input type="radio" name="identity" lay-skin="primary" value="admin" title="管理员">
                                    <input type="submit" class="layui-btn  layui-btn-radius" value="登陆">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="layui-tab-item">
                        <div class="layui-anim layui-anim-up">
                            ...
                            <form action="register" class="layui-form layui-form-pane"
                                ...
                                <div class="layui-form-item">
                                    <input type="submit" class="layui-btn  layui-btn-radius layui-btn-fluid "
                                           value="注册">
                                </div>
                            </form>
