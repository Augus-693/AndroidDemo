            ...
            <div class="layui-card">
                <div class="layui-card-header">
                    <div class="layui-col-xs4">
                        <i class="layui-icon layui-icon-username">读者ID:<%=a.get(i).reader_id%>
                        </i>
                    </div>
                    <div class="layui-col-xs4">
                        <i class="layui-icon layui-icon-date">借出日期：<%=a.get(i).start_date%>
                        </i>
                    </div>
                    <div class="layui-col-xs4">
                        <i class="layui-icon layui-icon-date">归还日期：<%=a.get(i).end_date%>
                        </i>
                    </div>
                </div>
