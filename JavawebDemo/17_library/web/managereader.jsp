<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" import="java.util.*,fun.augus.DB.*" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-card">
                <div class="layui-card-header">
                    <div class="layui-col-xs4">
                        <i class="layui-icon layui-icon-username">读者ID:<%=a.get(i).getReader_id()%>
                        </i>
                    </div>
                    <div class="layui-col-xs4">
                        <i class="layui-icon layui-icon-friends">姓名：<%=a.get(i).getReader_name()%>
                        </i>
                    </div>
                    <div class="layui-col-xs4">
                        <i class="layui-icon layui-icon-cellphone-fine">电话：<%=a.get(i).getReader_tel() %>
                        </i>
                    </div>
                </div>
