...
public class Database {
    ...
    String url = "jdbc:mysql://localhost:3306/" + dbName + "?useUnicode=true&character=utf8&useSSL=false&serverTimezone=UTC";
    Connection con = null;
    Statement s;
    ResultSet rs;
    //单件模式
    ...
    public String checklogin(String id, String pwd, String identity) {
        try {
            ...
            if (identity.equals("reader")) {
                ...
                sql = "select * from admin where admin_id = ? and  pwd = ?";
            }
    ...
    public static Database getDatabase() throws InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {//����ģʽ
        if (db == null) {
            try {
                db = new Database();
